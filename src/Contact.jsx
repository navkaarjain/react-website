...
const formSubmit=(e)=>{
    e.preventDefault();
    alert(`My name is ${data.fullname}. My mobile number is ${data.phone} and email is ${data.email}, Here is i want to say ${data.msg}`)
};

  return (<>
  <div className='my-5'>
      <h1 className='text-center'>Conytact Us</h1>
  </div>
